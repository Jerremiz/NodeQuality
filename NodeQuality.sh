...
bench_os_url="https://v4.gh-proxy.org/https://github.com/LloydAsp/NodeQuality/releases/download/v0.0.2/BenchOs.tar.gz"
raw_file_prefix="https://v4.gh-proxy.org/https://raw.githubusercontent.com/LloydAsp/NodeQuality/refs/heads/main"
